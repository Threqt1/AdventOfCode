exports.run = function (input1) {
    ...
    console.log("Puzzle 6-2: " + (frequency.get("0") + frequency.get("1") + frequency.get("2") + frequency.get("3") + frequency.get("4") + frequency.get("5") + frequency.get("6") + frequency.get("7") + frequency.get("8")))
}